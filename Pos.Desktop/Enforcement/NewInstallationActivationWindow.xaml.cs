...
public partial class NewInstallationActivationWindow : Window, IDisposable
{
    private readonly NewInstallationActivationViewModel _viewModel;
    private readonly CancellationTokenSource _cancellationTokenSource = new();
    private bool _disposed;

    public NewInstallationActivationWindow(NewInstallationActivationViewModel viewModel)
    {
        InitializeComponent();
